...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"public/script/api.js":[function(require,module,exports) {
"use strict";
...
function _getApi() {
  _getApi = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(route) {
    var res;
...
var _validInput = require("./validInput");

//Custom event that is listiening for example from display.js
var filterRequest = new CustomEvent('filter');
fBtt.addEventListener('click', function () {
  document.dispatchEvent(filterRequest);
});

function makeFilters(fItems) {
  (0, _loading.isLoading)('#filter-menu');
  ...
  for (var key in fItems) {
    ...
    block.setAttribute('id', "input-".concat(key));
    td.appendChild(block);

    if (key != 'title') {
      document.getElementById(fItems[key].input).addEventListener('input', _validInput.invalidLet);
    } else {
      document.getElementById(fItems[key].input).addEventListener('input', _validInput.invalidNum);
    }
  }
  ...
  function setDefaults() {
    ...
    var default_id = localStorage.getItem('id');
    var default_userid = localStorage.getItem('userId');
    var default_title = localStorage.getItem('title');
  ...
  setDefaults();
  (0, _loading.isLoaded)('#filter-menu');
}

function filtering(posts, fItems) {
  var place;
...
},{"./loading":"public/script/universal/loading.js","./validInput":"public/script/universal/validInput.js"}],"public/script/display.js":[function(require,module,exports) {
"use strict";
...
exports.removeDisBox = removeDisBox;
...
document.addEventListener('filter', function () {
  removeDisBox();
  displayBlocks();
});
var button = document.getElementById('fBtt');
var fItems = {
  id: {
    input: 'input-id',
...
(0, _filtering.makeFilters)(fItems);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            if ((0, _filtering.filtering)(posts, fItems) != undefined) {
              posts = (0, _filtering.filtering)(posts, fItems);
            }

            ;
            (0, _filtering.sorting)(posts, fItems);
            x = 0;
            ...
            if (input_id.value || input_userid.value || input_title.value) {
              if ((0, _check.checkLet)(input_id.value) || (0, _check.checkLet)(input_userid.value) || (0, _check.checkNum)(input_title.value)) {
...
displayBlocks();
},{"./api":"public/script/api.js","./universal/filtering":"public/script/universal/filtering.js","./universal/check":"public/script/universal/check.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
